      ...
      <div class="container">
        <div class="youtube__inner">
          ...
          <div class="youtube__list">
            <ul>
              <li v-for="movie in movies" :key="movie.videoId">
                <a
...
export default {
  ...
  setup() {
    ...
    const SearchMovies = () => {
      ...
      fetch(
        `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=28&q=${search.value}&key=AIzaSyD1W73Bddv7y3XeQHtO3LGFC65kFQ4ImJY&type=video`,
        requestOptions
      )
